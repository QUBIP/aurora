...
#[path = "./MLDSA44_Ed25519/keymgmt_functions_draft07.rs"]
...
#[cfg(feature = "_composite_sigs_draft_12_postWGLC")]
pub(super) const NAMES: &CStr = c"id-MLDSA44-Ed25519-SHA512:mldsa44_ed25519:1.3.6.1.5.5.7.6.39";
...
#[cfg(feature = "_composite_sigs_draft_07")]
pub(crate) const OID: asn1::ObjectIdentifier = asn1::oid!(2, 16, 840, 1, 114027, 80, 9, 1, 2);
#[cfg(feature = "_composite_sigs_draft_07")]
...
// OID from https://www.ietf.org/archive/id/draft-ietf-lamps-pq-composite-sigs-12.html#name-algorithm-identifiers-and-p
/// OID should be a substring of NAMES
#[cfg(feature = "_composite_sigs_draft_12")]
pub(crate) const OID: asn1::ObjectIdentifier = asn1::oid!(2, 16, 840, 1, 114027, 80, 9, 1, 22);
#[cfg(feature = "_composite_sigs_draft_12")]
pub(crate) const OID_PKCS8: pkcs8::ObjectIdentifier =
    pkcs8::ObjectIdentifier::new_unwrap("2.16.840.1.114027.80.9.1.22");
#[cfg(feature = "_composite_sigs_draft_12")]
pub(crate) const SIGALG_OID: Option<&CStr> = Some(c"2.16.840.1.114027.80.9.1.22");

// OID from https://github.com/lamps-wg/draft-composite-sigs/blob/a0b0c6b7f10bbb99d3e945ae8cb34035cc5be591/src/algParams.md
/// OID should be a substring of NAMES
#[cfg(feature = "_composite_sigs_draft_12_postWGLC")]
pub(crate) const OID: asn1::ObjectIdentifier = asn1::oid!(1, 3, 6, 1, 5, 5, 7, 6, 39);
#[cfg(feature = "_composite_sigs_draft_12_postWGLC")]
pub(crate) const OID_PKCS8: pkcs8::ObjectIdentifier =
    pkcs8::ObjectIdentifier::new_unwrap("1.3.6.1.5.5.7.6.39");
#[cfg(feature = "_composite_sigs_draft_12_postWGLC")]
pub(crate) const SIGALG_OID: Option<&CStr> = Some(c"1.3.6.1.5.5.7.6.39");
...
// Ensure proper null-terminated C string
pub(super) const DESCRIPTION: &CStr = c"mldsa44_ed25519 from pqclean and libcrux";

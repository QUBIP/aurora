...
impl Encoder for PrivateKeyInfo2DER {
    const PROPERTY_DEFINITION: &'static CStr =
        c"x.author='QUBIP',x.qubip.adapter='rustcrypto',output='der',structure='PrivateKeyInfo'";
...
impl Encoder for PrivateKeyInfo2PEM {
    const PROPERTY_DEFINITION: &'static CStr =
        c"x.author='QUBIP',x.qubip.adapter='rustcrypto',output='pem',structure='PrivateKeyInfo'";
...
impl Encoder for SubjectPublicKeyInfo2DER {
    const PROPERTY_DEFINITION: &'static CStr =
        c"x.author='QUBIP',x.qubip.adapter='rustcrypto',output='der',structure='SubjectPublicKeyInfo'";
...
impl Encoder for SubjectPublicKeyInfo2PEM {
    const PROPERTY_DEFINITION: &'static CStr =
        c"x.author='QUBIP',x.qubip.adapter='rustcrypto',output='pem',structure='SubjectPublicKeyInfo'";
